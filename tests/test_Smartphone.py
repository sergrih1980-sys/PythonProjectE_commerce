...
def test_smartphone_add_error_product(product_smartphone, product_smartphone2):
    with pytest.raises(TypeError, match="Нельзя складывать смартфон с другим типом товара"):
